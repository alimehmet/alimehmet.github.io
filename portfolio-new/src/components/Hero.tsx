...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20 cursor-default"
    >
      {/* Animated Background */}
      <div className="absolute inset-0 -z-10">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 -right-32 w-96 h-96 bg-accent-purple/20 rounded-full blur-3xl"
          style={{ backgroundColor: "rgba(93, 45, 136, 0.2)" }}
          animate={{
            x: [0, -50, 0],
            y: [0, -30, 0],
            scale: [1, 1.2, 1],
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent-orange/10 rounded-full blur-3xl"
          style={{ backgroundColor: "rgba(234, 76, 17, 0.1)" }}
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(77, 132, 57, 0.5) 1px, transparent 1px),
                             linear-gradient(90deg, rgba(77, 132, 57, 0.5) 1px, transparent 1px)`,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
              ...
              {personalInfo.aboutText.map((text, index) => (
                <p
                  ...
                  className={`text-muted-foreground ${
                    index === 1 ? "text-lg font-medium text-foreground" : ""
                  }`}
                >
                  {text}
                </p>
            ...
            >
              ...
              <motion.a
                href="#about"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-card border border-primary/50 text-primary font-medium hover:bg-primary/10 transition-colors"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            >
              {/* Glowing ring */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary via-[#5d2d88] to-[#ea4c11] opacity-20 blur-2xl animate-pulse" />
              
              {/* Logo container */}
              <div className="relative w-full h-full rounded-full bg-card/50 backdrop-blur-sm border border-border/50 p-8 flex items-center justify-center">
                <Image
